# Deploying Rock Steady Boxing Santa Monica
...
2. Enter `rocksteadyboxingsantamonica.com` → **Verify** → **Add domain**.
...
- Set `https://rocksteadyboxingsantamonica.com` as the primary domain so
